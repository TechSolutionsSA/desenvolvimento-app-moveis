package com.example.gerenciador_contratos.features.ContratosAtivos
...
class ContratosaAtivosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_contratos_ativos)

        recyclerView = findViewById(R.id.recyclerViewContratos)
        recyclerView.layoutManager = LinearLayoutManager(this)

        RetrofitClient.apiService.getContratosAtivos().enqueue(object : Callback<List<Contrato>> {
